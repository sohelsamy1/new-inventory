...
@section('content')
    ...
    <nav class="navbar sticky-top shadow-sm navbar-expand-lg navbar-light py-2">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-12 col-lg-5 mb-5 mb-lg-0">
                        ...
                        <p class="text-muted mb-5">Jatrabari, Dhaka, Bangladesh</p>
                        <h4 class="fw-bold">Contact Us</h4>
                        <p class="text-muted mb-1">sohelsamy18@gmail.com</p>
                        <p class="text-muted mb-0">+8801676724318</p>
                    </div>
                    <div class="col-12 col-lg-6 offset-lg-1">
                        <form action="#">
        ...
        <footer class="py-5 bg-light">
            ...
            <div class="mb-5"></div>
            <div class="container">
                <p class="text-center">All rights reserved © sohel samy 2023-2024</p>
            </div>
        </footer>
